...
const SignUpScreen = ({ navigation }) => {
    ...
    const handleSubmitButton = async () => {
        ...
        axios.post(
            ...
            `http://192.168.43.36:4000/Admin/register`,
            formBody
        )
            .then((res) => {
    ...
    if (isRegistraionSuccess) {
        return (
            ...
            /> */}
              ...
              <Text style={styles.buttonTextStyle}>Open Email</Text>
            </TouchableOpacity> */}
                <TouchableOpacity
                    style={styles.signIn}
                    activeOpacity={0.5}
                ...
                <ScrollView>
                    ...
                    {data.isValidUser ? null :
                        <Animatable.View animation="fadeInLeft" duration={500}>
                            <Text style={styles.errorMsg}>Name must be atleast 4 characters long.</Text>
                        </Animatable.View>
                    }
                    ...
                    {data.isValidPassword ? null :
                        <Animatable.View animation="fadeInLeft" duration={500}>
                            <Text style={styles.errorMsg}>Password must be atleast 4 characters long.</Text>
                        </Animatable.View>
                    }
